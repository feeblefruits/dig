jQuery(document).ready(function($){
	...
	var ts = new TwoStep({
	    ...
	    narrative: [
	        ...
	        function(event) {
	            $('.floating-box').html(contentList[1]);
	        },
	        function(event) {
	            $('.floating-box').html(contentList[2]);
	        },
	        function(event) {
	            $('.floating-box').html(contentList[3]);
	        },
	        function(event) {
	            $('.floating-box').html(contentList[4]);
	        },
	        function(event) {
	            $('.floating-box').html(contentList[5]);
	        },
	        function(event) {
	            $('.floating-box').html(contentList[6]);
	        },
	        function(event) {
	            $('.floating-box').text(contentList[7]);
	        },
	        function(event) {
	            $('.floating-box').text(contentList[8]);
	        },
	        function(event) {
	            $('.floating-box').text(contentList[9]);
	        },
	        function(event) {
	            $('.floating-box').text(contentList[10]);
	        },
	        function(event) {
	            $('.floating-box').text(contentList[11]);
	        },
	        function(event) {
	            $('.floating-box').text(contentList[12]);
	        },
	        function(event) {
	...
	//variables
	var hijacking= $('.stories').data('hijacking'),
		animationType = $('.stories').data('animation'),
		delta = 0,
        scrollThreshold = 5,
        actual = 1,
        animating = false;
    ...
    function unbindScroll(section, time) {
    	...
    	if( hijacking == 'off') {
    		$(window).off('scroll', scrollAnimation);
    		( animationType == 'catch') ? $('.stories').scrollTop(section.offset().top) : section.velocity("scroll", { duration: time });
    	}
    }
	...
	function deviceType() {
		...
		return window.getComputedStyle(document.querySelector('.stories'), '::before').getPropertyValue('content').replace(/"/g, "").replace(/'/g, "");
	}
